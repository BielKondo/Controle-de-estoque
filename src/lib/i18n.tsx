...
const translations = {
  en: {
    ...
    password: 'Password',
    forgotPassword: 'Forgot / First access?',
    ...
    resetPasswordDesc: 'Enter your email and we\'ll send a link to set your password.',
  ...
  pt: {
    ...
    password: 'Senha',
    forgotPassword: 'Esqueceu / Primeiro acesso?',
    rememberDevice: 'Lembrar este dispositivo',
    signIn: 'Entrar no Dashboard',
    signingIn: 'Entrando...',
    newPlatform: 'Novo na plataforma?',
    contactSupport: 'Contatar Suporte',
    resetPasswordTitle: 'Definir / Redefinir Senha',
    resetPasswordDesc: 'Digite seu e-mail e enviaremos um link para definir sua senha.',
